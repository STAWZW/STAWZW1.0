...
def forestFire_ZH004():
    result = spiderConfig.spiderConfig('forestFire_ZH004')
    if result['status'] == '1':
        ...
        timrFor = Timer(frequency*60*60,forestFire_ZH004)
        timrFor.start()
    else:
        print('forestFire_ZH004爬虫停止')
        timrFor = Timer(1*60*60,forestFire_ZH004)
        timrFor.start()
