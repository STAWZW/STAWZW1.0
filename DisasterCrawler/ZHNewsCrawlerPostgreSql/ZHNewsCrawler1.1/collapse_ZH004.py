...
# ---------------------------------------------------------------
def collapse_ZH004():
    result = spiderConfig.spiderConfig('collapse_ZH004')
    if result['status'] == '1':
        ...
        timrFor = Timer(frequency*60*60,collapse_ZH004)
        timrFor.start()
    else:
        print('collapse_ZH004爬虫停止')
        timrFor = Timer(1*60*60,collapse_ZH004)
        timrFor.start()
