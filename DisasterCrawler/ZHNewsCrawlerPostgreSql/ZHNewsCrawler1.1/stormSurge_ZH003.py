...
def stormSurge_ZH003():
    result = spiderConfig.spiderConfig('stormSurge_ZH003')
    if result['status'] == '1':
        ...
        timrFor = Timer(frequency*60*60,stormSurge_ZH003)
        timrFor.start()
    else:
        print('stormSurge_ZH003爬虫停止')
        timrFor = Timer(1*60*60,stormSurge_ZH003)
        timrFor.start()
