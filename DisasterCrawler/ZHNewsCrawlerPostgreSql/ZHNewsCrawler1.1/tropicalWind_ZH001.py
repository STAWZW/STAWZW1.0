...
def tropicalWind_ZH001():
    result = spiderConfig.spiderConfig('tropicalWind_ZH001')
    if result['status'] == '1':
        ...
        timrFor = Timer(frequency*60*60,tropicalWind_ZH001)
        timrFor.start()
    else:
        print('tropicalWind_ZH001爬虫停止')
        timrFor = Timer(1*60*60,tropicalWind_ZH001)
        timrFor.start()
