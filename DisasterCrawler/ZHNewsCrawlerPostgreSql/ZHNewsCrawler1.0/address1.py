...
text1 = '新华社苏瓦6月16日电（记者张永兴）努库阿洛法消息：南太平洋岛国汤加16日发生6.1级地震。目前尚无人员伤亡和财产损失报告。据美国地质调查局地震信息网消息，此次地震发生在当地时间16日10时56分（北京时间5时56分），震中位于埃瓦岛首府奥霍努阿东北97公里处，震源深度10公里。太平洋海啸预警中心没有针对此次地震发布海啸预警。汤加位于环太平洋火山地震带，因地壳板块相互碰撞地震频发。'

print(placeSingle(text1))
