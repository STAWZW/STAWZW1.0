...
def disasterNB(text):
    result = {'雪崩': '1000101', '冰崩': '1000102', '岩崩': '1000103', '岩石崩塌': '1000103', '山体崩塌': '1000104'}
    collapseList = ['雪崩','冰崩','岩崩','岩石崩塌','山体崩塌']
    itemIndex = 5
...
def collapse_ZH001():
    ...
    for item in range(0, 20):
        try:
            url = 'https://search.cctv.com/search.php?qtext=%E5%B1%B1%E4%BD%93%E5%B4%A9%E5%A1%8C&sort=relevance&type=web&vtime=&datepid=1&channel=&page=' + str(item)
            infos_paser(url)
        except Exception as e:
