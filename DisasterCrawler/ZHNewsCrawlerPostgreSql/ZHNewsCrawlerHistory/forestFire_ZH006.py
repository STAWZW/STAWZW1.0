...
def forestFire_ZH006():
    ...
    for item in range(0, 15):
        try:
            url = 'https://search.cctv.com/search.php?qtext=%E6%A3%AE%E6%9E%97%E7%81%AB%E7%81%BE&sort=relevance&type=web&vtime=&datepid=1&channel=&page=' + str(item)
            infos_paser(url)
        except Exception as e:
